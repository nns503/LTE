...
public record GetPostsRequest(
        @Schema(description = "검색 내용 조건", example = "TITLE", nullable = true)
        PostSearchBy searchBy,
        @Schema(description = "검색 내용", example = "나테스트", nullable = true)
        String searchValue,
        @Schema(description = "정렬 조건", example = "DATE", nullable = true)
        PostSortBy sortBy
) {
}

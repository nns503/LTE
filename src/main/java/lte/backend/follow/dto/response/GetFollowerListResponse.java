...
public record GetFollowerListResponse(
    ...
    public static GetFollowerListResponse from(Slice<FollowDTO> followerList) {
        return new GetFollowerListResponse(followerList.getContent(), SliceInfo.from(followerList));
    }
}
